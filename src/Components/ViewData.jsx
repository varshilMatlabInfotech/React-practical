...
<div className="border-b border-gray-200 dark:border-gray-700">
  <ul className="flex flex-wrap -mb-px text-sm font-medium text-center text-gray-500 dark:text-gray-400">
    <li className="me-2" onClick={handleClick}>
      <Link to='/alldata' className={`${selected?'text-blue-600':''} inline-flex items-center justify-center p-4 border-b-2 border-transparent rounded-t-lg hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300 group`}>
    ...
    <li className="me-2" onClick={handleClick}>
      <Link to='/bookmarkdata' href="#" className={`${selected?'text-blue-600':''} inline-flex items-center justify-center p-4  border-b-2 rounded-t-lg dark:text-blue-500  `} aria-current="page">
